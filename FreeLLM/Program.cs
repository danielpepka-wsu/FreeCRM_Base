using FreeLLM.Components;
using FreeLLM.Server.Controllers;
...
namespace FreeLLM
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeLLM.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeLLM.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freellmHub>("/freellmHub", signalRConnctionOptions => {
            ...
            app.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(typeof(FreeLLM.Client.Pages.Index).Assembly);
