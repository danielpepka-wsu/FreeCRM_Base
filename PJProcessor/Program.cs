...
using PJProcessor.Server.Controllers;
...
namespace PJProcessor
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(PJProcessor.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(PJProcessor.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<pjprocessorHub>("/pjprocessorHub", signalRConnctionOptions => {
            ...
            app.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(typeof(PJProcessor.Client.Pages.Index).Assembly);
