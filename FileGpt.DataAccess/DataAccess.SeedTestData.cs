...
#if DEBUG
        if (_connectionString == "Data Source=localhost;Initial Catalog=FileGpt;TrustServerCertificate=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;") {
