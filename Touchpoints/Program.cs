using Touchpoints.Components;
using Touchpoints.Server.Controllers;
using Touchpoints.Server.Hubs;
...
namespace Touchpoints
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(Touchpoints.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(Touchpoints.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<touchpointsHub>("/touchpointsHub", signalRConnctionOptions => {
            ...
            app.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(typeof(Touchpoints.Client.Pages.Index).Assembly);
