using FileGpt.Components;
using FileGpt.Server.Controllers;
...
namespace FileGpt
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FileGpt.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FileGpt.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<FileGpthub>("/FileGpthub", signalRConnctionOptions => {
            ...
            app.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(typeof(FileGpt.Client.Pages.Index).Assembly);
