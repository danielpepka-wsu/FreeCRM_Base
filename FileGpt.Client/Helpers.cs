...
public static class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FileGpt.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
