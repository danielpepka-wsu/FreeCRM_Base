...
namespace Touchpoints.EFModels.EFModels;
...
public partial class EFDataModel : DbContext
{
    ...
    // => optionsBuilder.UseSqlite("Data Source=C:\\Working\\Touchpoints.db");
    // => optionsBuilder.UseMySQL("Server=localhost;Database=Touchpoints;User=admin;Password=admin");
    // => optionsBuilder.UseNpgsql("Host=localhost;Database=Touchpoints;Username=postgres;Password=admin");
    // => optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=Touchpoints;Persist Security Info=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;TrustServerCertificate=True;");
